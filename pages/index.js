        ...
        <div className="card">
          {!submitting ? (
            <div>
              ...
              <div>
                <h3 className="py-2 text-xl">How did we do?</h3>
                <p className="py-2 text-sm">
                  Please let us know how we did with your support request. All
                  feedback is appreciated to help us improve our offering!
                </p>
              </div>
              <form onSubmit={handleOnSubmit} className="py-4">
            ...
            <div className="text-center ">
              {submitting && (
                ...
                <div className="flex justify-center items-center py-4">
                  ...
                  <div className="my-3 rounded-xl bg-slate-600 ">You selected {selectedRating} out of 5</div>
                  <h2 className="pb-2 text-xl font-bold ">Thank You!</h2>
                  <p className="text-sm">
